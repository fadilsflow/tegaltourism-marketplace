  ...
  return (
    <>
      <div className="flex flex-col  gap-8 py-10 ">
        ...
        <section id="tickets" className="  flex flex-col container mx-auto px-6 md:px-12">
          <Badge variant={"secondary"} className="mb-8">Tiket Wisata</Badge>
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="relative z-10 max-w-xl text-xl font-medium lg:text-2xl">Tiket Wisata Terbaru</h2>
              <p className="text-md text-muted-foreground font-light">
                Jelajahi destinasi wisata menarik dengan tiket terbaik
              </p>
            </div>
            <Link href="/products?type=ticket">
              <Button variant="outline" className="hidden sm:flex">
                Lihat Semua Tiket
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
          ...
          <TicketList sortBy="latest" limit={8} />
