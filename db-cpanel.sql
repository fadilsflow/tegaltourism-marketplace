...
--
-- Host: localhost:3306
-- Generation Time: Nov 22, 2025 at 08:27 PM
...
--
-- Database: `u1578105_tegaltourism-marketplace`
--
...
CREATE TABLE `ads` (
  ...
  `reward_coin` int(11) NOT NULL DEFAULT 0,
...
--
ALTER TABLE `ad_claims`
  ADD CONSTRAINT `ad_claims_ad_id_ads_id_fk` FOREIGN KEY (`ad_id`) REFERENCES `ads` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_address_id_address_id_fk` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`),
